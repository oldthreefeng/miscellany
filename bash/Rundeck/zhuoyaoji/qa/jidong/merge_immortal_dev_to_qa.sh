...
function merge_code () {
	...
	dev_svn_base=https://svn.jidongnet.com/svn/immortal/dev/server/tag/
	...
	rsync -avz --exclude "static/"  --exclude ".svn" $dev_svn_dir/$platform/$version/  $qa_svn_dir/$platform/$version
