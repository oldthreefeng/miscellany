...
if [ -d "/data/gamecode/$platform/new/$version/conf/apple/" ];then
   echo "/data/gamecode/$platform/new/$version/conf/apple  exists!"
else
   mkdir -p /data/gamecode/$platform/new/conf/apple
fi
...
function update_resource () {
       ...
       cd /data/immortal_demo_gamecode/apple/
       
       echo "php  public/index.php -p apple -e prod -s 10000 -i version/update"

       if php  public/index.php -p apple -e prod -s 10000 -i version/update | grep error ;then 
