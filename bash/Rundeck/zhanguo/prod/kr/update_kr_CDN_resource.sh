...
cat $hot_file
hot_version_dir=kr$version\_$hot_version
echo $hot_version_dir
sudo rsync -avz $cdndir/*  --exclude ".svn"    cdn/$hot_version_dir
sudo rsync  -avz --port=8733  --exclude ".svn/"  cdn/$hot_version_dir  cdn/confirm_rsync  210.65.163.123::zgzd.static.kingnet.com
sudo rsync  -avz --port=8733  --exclude ".svn/"  cdn/$hot_version_dir  cdn/confirm_rsync  210.65.163.123::zgzd.static.kingnet.com
sudo rsync  -avz --port=8733  --exclude ".svn/"  cdn/$hot_version_dir  cdn/confirm_rsync  210.65.163.123::zgzd.static.kingnet.com
