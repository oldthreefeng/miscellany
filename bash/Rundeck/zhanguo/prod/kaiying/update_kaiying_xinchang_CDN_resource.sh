version=2.1.3
cdndir=/svn/kingnet/$version/game_server/htdoc/resource
svn up $cdndir
...
cat $hot_file
hot_version_dir=ky$version\_$hot_version
sudo rsync  --progress   -avz $cdndir/*  --exclude ".svn"    cdn/$hot_version_dir
sudo rsync   --progress  -avz --port=8733  --exclude ".svn/"  cdn/$hot_version_dir  cdn/confirm_rsync  210.65.163.123::zgzd.static.kingnet.com
sudo rsync   --progress  -avz --port=8733  --exclude ".svn/"  cdn/$hot_version_dir  cdn/confirm_rsync  210.65.163.123::zgzd.static.kingnet.com
sudo rsync  --progress   -avz --port=8733  --exclude ".svn/"  cdn/$hot_version_dir  cdn/confirm_rsync  210.65.163.123::zgzd.static.kingnet.com
