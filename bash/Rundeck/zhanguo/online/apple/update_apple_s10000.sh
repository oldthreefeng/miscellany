...
ssh -t  wangdeyuan@101.231.68.46 "ssh sengoku@10.10.41.42 'cd /data/tools/updatecode/apple/;sh update_jidong_apple_CDN_resource.sh;sh update_jidong_apple_gamecode.sh'" 
