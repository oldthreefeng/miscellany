...
hot_version_file=/data/zhanguo_demo_gamecode/jp/hot_version.txt
...
do
    ...
    do 
             ...
             grep -E --color 'hot_version|hot_update_url' /data/zhanguo_demo_gamecode/jp/config/app.conf.php|mail -s "Japan Platform Hot Version $hot_version" wangdy@jidonggame.com  wangws@jidonggame.com xugl@jidonggame.com
