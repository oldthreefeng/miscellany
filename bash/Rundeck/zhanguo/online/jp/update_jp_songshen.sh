...
ssh -t  wangdeyuan@101.231.68.46 "ssh sengoku@10.10.41.42 'cd /data/tools/updatecode/jp/;sh update_jp_songshen_logincode.sh;sh update_jp_songshen_gamecode.sh'"



dir_base=/data/jp_songshen/zhanguo_server/
