#!/bin/bash
user=sengoku
hostfile=/data/tools/gamecode_rsync/apple/serverlist.txt.tmp
#tmp_file=/data/zhanguo_demo_gamecode/apple/cron/country_bonus.php 
tmp_file=player_const.class.php.tmp
...
#            rsync -avz $tmp_file  $user@$host:$rootdir/app/
