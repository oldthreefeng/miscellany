...
function rsync_code () {
    user=sengoku
    source=/data/zhanguo_demo_gamecode/kaiying/
    ...
    echo "###############Rsync Code Source $source################"
        ...
        do 
             ...
             rsync  $testrun   -aP  --exclude="include/initerioruser.php"   --exclude="data/events.php"   --exclude "data/tools_release_events.php"   --exclude "config/app.conf.php*"  --exclude "htdoc/resource/*" --exclude ".svn/" --exclude "cron/*"  "$source"    sengoku@"$host"::"$dest"
