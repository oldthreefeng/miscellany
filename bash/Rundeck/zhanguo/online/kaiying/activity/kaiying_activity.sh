...
rsync -avz /data/zhanguo_demo_gamecode/kaiying/data/tools_release_events.php  /data/zhanguo_demo_gamecode/xinchang/data/
...
sh /data/tools/gamecode_rsync/xinchang/activity/xinchang_activity.sh 
