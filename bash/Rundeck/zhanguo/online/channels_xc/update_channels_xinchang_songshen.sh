...
ssh -t  wangdeyuan@101.231.68.46 "ssh sengoku@10.10.41.42 'cd /data/tools/updatecode/channels_xc/;sh update_channels_xinchang_songshen_logincode.sh;sh update_channels_xinchang_songshen_gamecode.sh'"



dir_base=/data/zhanguo_app/channels_xc/xinchang_server
