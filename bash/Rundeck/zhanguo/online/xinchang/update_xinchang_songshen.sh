...
ssh -t  wangdeyuan@101.231.68.46 "ssh sengoku@10.10.41.42 'cd /data/tools/updatecode/kaiying/;sh                        update_kaiying_xinchang_songshen_logincode.sh;sh update_kaiying_xinchang_songshen_gamecode.sh'"


dir_base=/data/xinchang_songshen/zhanguo_server/
