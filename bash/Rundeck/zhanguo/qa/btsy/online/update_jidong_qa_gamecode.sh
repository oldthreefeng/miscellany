...
QA_GAMECODE_DIR="/data/zhanguo_app/$platform/zhanguo_server/
	        /data/zhanguo_app/$platform/zhanguo_server_2/
		/data/zhanguo_app/$platform/zhanguo_server_3/
		/data/zhanguo_app/$platform/zhanguo_server_4/"
...
sudo service php-fpm reload
  ...
  gmconfig=/pub_code/new/backend_btsy_dev_42/protected/apps/zg/config/api.yml
