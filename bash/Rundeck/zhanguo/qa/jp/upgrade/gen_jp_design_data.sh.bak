...
rsync -avz --delete --exclude ".svn"   tmp_svn_data/xml/   $qa_svn_dir/game_server/xml/out_list/|awk '$1=="deleting"{print $2}' >> /tmp/rsync_deleted_files_$platform.txt   

sudo svn export --force   -q  $design_svn_base/$platform/$version/php   tmp_svn_data/php
rsync -avz --delete --exclude ".svn"  tmp_svn_data/php/   $qa_svn_dir/game_server/data/formula/|awk '$1=="deleting"{print $2}' >> /tmp/rsync_deleted_files_$platform.txt

sudo svn export --force   -q  $design_svn_base/$platform/$version/resource   tmp_svn_data/resource
rsync -avz --delete --exclude ".svn"   tmp_svn_data/resource/   $qa_svn_dir/game_server/htdoc/resource/|awk '$1=="deleting"{print $2}' >> /tmp/rsync_deleted_files_$platform.txt
...
qa_config_file=/data/zhanguo_app/jp_new/zhanguo_server/config/app.conf.php
