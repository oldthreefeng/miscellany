...
qa_config_file=/data/zhanguo_app/360_new/zhanguo_server/config/app.conf.php
...
cat `date +"%F%R"` >> /tmp/gen_data.log
cat `date +"%F%R"` >> /tmp/gen_autoload.log
php /data/svn/$platform/$version/game_server/tools/gen_data.php  &> /tmp/gen_data.log
php /data/svn/$platform/$version/game_server/tools/gen_autoload.php &> /tmp/gen_autoload.log
