...
QA_GAMECODE_DIR="/data/xinchang_app/channels/zhanguo_server/
		/data/xinchang_app/channels/zhanguo_server_2/
		/data/xinchang_app/channels/zhanguo_server_3/
		/data/xinchang_app/channels/zhanguo_server_4/	
		/data/xinchang_app/channels/jc_zhanguo_server/"
