...
do 
  ...
  sudo  rm -rf $qa_svn_dir/game_server/htdoc/resource/$dir     
...
qa_config_file=/data/xinchang_app/channels/zhanguo_server/config/app.conf.php
...
sudo sed -i "/hot_version/s/$svn_hot_version_old/$svn_hot_version_new/" $svn_config_file
