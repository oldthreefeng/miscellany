...
QA_GAMECODE_DIR="/data/zhanguo_app/kaiying_new/zhanguo_server/
		/data/zhanguo_app/kaiying_new/zhanguo_server_2/
		/data/zhanguo_app/kaiying_new/zhanguo_server_3/
		/data/zhanguo_app/kaiying_new/zhanguo_server_4/"
