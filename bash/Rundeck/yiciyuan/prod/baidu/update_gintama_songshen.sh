...
function update_code () {
    ...
    if [ $platform == "jidongadr" ];then
    	sudo rsync -avz    $qa_gamecode_dir/config/$platform/version_old.ini    $qa_gamecode_dir/config/$platform/rand_name.php     $qa_gamecode_dir/config/$platform/sensitive_words.php       $YIWAN::${platform}_songshen/game_code/config/bdyy/
    fi
