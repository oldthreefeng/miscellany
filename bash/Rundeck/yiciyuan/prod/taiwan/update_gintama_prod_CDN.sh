...
demo_server="gintama-taiwan-demo"
cdn_server="gintama-taiwan-cdn"
...
rsync -avz  $hot_file    $demo_server::$platform/game_code/


sudo rsync -avz  --exclude ".svn" $prod_svn_dir/game_code/data    $demo_server::$platform/game_code/

sudo rsync -avz $cdndir/*  --exclude ".svn"    cdn/$version

#60.191.203.70  /data/cdn_data/gintama/jidong/ 需要存在

#sudo rsync -avz cdn/$hot_version_dir  $cdn_server::gintamacdn/$platform/$version
sudo rsync -rvz -I cdn/$hot_version_dir  $cdn_server::gintamacdn/$platform/$version
...
sudo rsync -avz $cdn_dir/cdn/sound/  $cdn_server::gintamacdn/$platform/sound/
