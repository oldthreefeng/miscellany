...
def getGraphs(host_list,url, auth,graphtype=0):
    ...
    output = requestJson(url,values)
   # print output
    ucloud_redis_memory_output = []
    ucloud_redis_stats_output = []
    ucloud_mongodb_status_output = []
    ucloud_mysql_output = []
    for i in output:
       # print i
        if i['name'].startswith('Redis_Memory'):
           ucloud_redis_memory_output.append(i)
        elif i['name'].startswith('Redis_Stats'):
           ucloud_redis_stats_output.append(i)
        elif i['name'].startswith('MongoDB'):
           ucloud_mongodb_status_output.append(i)
        elif i['name'].startswith('MySQL'):
           ucloud_mysql_output.append(i)
    return  ucloud_redis_memory_output,ucloud_redis_stats_output,ucloud_mongodb_status_output,ucloud_mysql_output
...
#    hostname = args.hostname
    groupname = 'GintamaTaiwan Servers' 
