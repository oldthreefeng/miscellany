...
def getGraphs(host_list,url, auth,graphtype=0):
    ...
    output = requestJson(url,values)
   # print output
    kingnet_redis_memory_output = []
    kingnet_redis_stats_output = []
    kingnet_mongodb_status_output = []
    kingnet_mysql_status_output = []
    for i in output:
       # print i
        if i['name'].startswith('Redis_Memory'):
           kingnet_redis_memory_output.append(i)
        elif i['name'].startswith('Redis_Stats'):
           kingnet_redis_stats_output.append(i)
        elif i['name'].startswith('MongoDB'):
           kingnet_mongodb_status_output.append(i)
        elif i['name'].startswith('MySQL'):
           kingnet_mysql_status_output.append(i)
    return  kingnet_redis_memory_output,kingnet_redis_stats_output,kingnet_mongodb_status_output,kingnet_mysql_status_output
